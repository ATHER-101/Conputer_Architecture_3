...
public class Execute {
	...
	public Execute(Processor containingProcessor,IF_OF_LatchType iF_OF_Latch, OF_EX_LatchType oF_EX_Latch, EX_MA_LatchType eX_MA_Latch, EX_IF_LatchType eX_IF_Latch)
	{
	...
	public void performEX()
	{
		if(OF_EX_Latch.isEX_enable()){
			...
			if(OF_EX_Latch.getControl_Unit().isEnd){
